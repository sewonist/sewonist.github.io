...
$("document").ready(function () {
    ...
    $("#freq").on('keydown', function (event) {
/*
        if (shifted) {
            var delta = 10;
        } else {
        ...
        if (event.which == 38 || event.which == 104) {
            ...
            var newFreq = (parseInt($("#freq").val()) + delta)
            $("#freq").val(newFreq);
            if (typeof oscillator != 'undefined') {
...
$('#generatorForm input, #generatorForm button').keypress(function (e) {
